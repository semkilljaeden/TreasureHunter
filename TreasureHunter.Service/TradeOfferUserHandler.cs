...
namespace TreasureHunter.Service
{
    ...
    {
        public TradeOfferUserHandler(BotActor bot, SteamID sid) : base(bot, sid) { }
            ...
            if (IsAdmin)
            {
                ...
                else
                {
                    ...
                    if (offer.Items.NewVersion)
                    {
                        ...
                        {
                            Bot.AcceptAllMobileTradeConfirmations();
                            Log.Info("Counter offered successfully : New Offer ID: " + newOfferId);
                        }
                    }
                }
            }
        ...
        public override void OnMessage(string message, EChatEntryType type)
        {
            if (IsAdmin)
            {
                ...
                if (offer.Items.NewVersion)
                {
                    ...
                    {
                        Bot.AcceptAllMobileTradeConfirmations();
                        Log.Info("Trade offer sent : Offer ID " + newOfferId);
                    }
                }
